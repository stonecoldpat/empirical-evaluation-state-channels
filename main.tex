...
Our empirical evaluation confirms that based on the current state of the Ethereum network, the Funfair approach appears more suitable as this reduces the impact of economic attacks to undermine the safety guarantee provided by state channels. 
