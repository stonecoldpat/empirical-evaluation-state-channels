...
To set up the battleship game, both parties participate in a cut-and-choose protocol. 
...
In each turn, the player selects a slot to shoot using $\battleshipattackslot$ and the counterparty must reveal the slot's opening within a fixed time period. 
