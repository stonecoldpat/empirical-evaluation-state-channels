...
\begin{document}
	...
	\begin{table}
		...
		\caption{Costs of running the battleship game on-chain and within the state channel. We have approximated the cost in USD (\$) using the conversion rate of 1 ether = \$306 and the gas price of 2.6 Gwei which are the real world costs in September 2018. }\label{tab:costs}
	\end{table}
