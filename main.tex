...
In December 2017, cryptocurrencies achieved a market capitalisation of over \$1 trillion US dollars which caused a frenzy as users raced to purchase coins. 
However, this period of time also demonstrated the scalability issues 

Cryptocurrencies do not scale. The community are pursuing three appro
...
We provide an overview of the state channel contract to discuss how it is instantiated, how parties collectively authorise new states off-chain and how the dispute process is used to confirm the final state hash. 
